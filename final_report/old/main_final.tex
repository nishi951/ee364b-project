...
for all $t \geq 0$.
\end{prop}
Before proving this proposition, we prove the following lemmas about the behavior of PGD with respect to the eigenbasis of the problem.
Throughout, we denote $\mathbf{sgn}(a) = \ones\{a \geq 0\} - \ones\{a \leq 0\}$. 
\begin{lem}
